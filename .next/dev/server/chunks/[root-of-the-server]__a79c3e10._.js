...
"[project]/app/api/movies/add/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!response.ok) {
            ...
            return Response.json({
                error: error.detail || "Failed to add movie"
            }, {
        ...
        if (error instanceof TypeError && error.message.includes("fetch")) {
            return Response.json({
                error: "El backend no está corriendo. Por favor, inicia el servidor Python en el puerto 8000."
            }, {
                status: 503
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a79c3e10._.js.map